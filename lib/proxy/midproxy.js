    ...
    _done: function(resolve,reject){
        ...
        for ( var i = 0; i < queue.length; i++ ) {
            ( function( reqObj, k, cookie ) {
                ...
                reqObj.proxy.request( reqObj.params, function( data, setcookie, headers) {
                    args[ k ] = data;
                    ...
                    --cnt || args.push( headers ) && args.push( setcookies ) && resolve(args);

                }, function( err ) {
                    logger.error('Error in lib/proxy/midproxy.js. Caused by:' + err.message + '\n' + err.stack);
