  ...
  return function* (next){
    try{
      ...
      if(!this.login){
        if(type.indexOf('shop') != -1){
          this.redirect('http://login.shop.showjoy.com/?service=' + encodeURIComponent(this.protocol + '://' + this.hostname) + '&redirect_uri=' + encodeURIComponent(this.path));
          return;
        }
      }
    ...
    try {
      ...
      try{
        ...
        }else if(type == 'activity-shop' || type == 'activity-showjoy'){
