...
var InterfaceManager = require( path.join(process.cwd(),'/lib-cov/proxy/interfacemanager') );
var ProxyFactory = require( path.join(process.cwd(),'/lib-cov/proxy/proxyfactory') );
